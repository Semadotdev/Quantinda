                ...
                <div className="w-full max-w-sm rounded-2xl border border-gray-100 bg-white shadow-xl dark:border-gray-700 dark:bg-gray-900">
                  ...
                  <div className="border-t border-gray-100 dark:border-gray-700">
                    <Link
                      href="/inventory"
                      onClick={() => setLowStockOpen(false)}
                      className="flex items-center justify-between rounded-b-2xl px-4 py-3 text-sm font-medium text-emerald-600 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 transition-colors"
                    >
                      View in Inventory
